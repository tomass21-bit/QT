...
public slots:
    void ScreenDataFromQuery(QSqlQueryModel *allQuery, int typeRequest);
    void ScreenDataFromTable(QSqlTableModel *secondQuery, int typeRequest);
...
private:
    ...
    QString request_all = "SELECT title, description  FROM film  "; //Запрос не требуется.
