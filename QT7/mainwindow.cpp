    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this, &MainWindow::sig_ReadyDisplay,this, &MainWindow::ReadyDisplay);
...
QVector<uint32_t> MainWindow::ReadFile(QString path, uint8_t numberChannel)
{
    ...
    if(file.isOpen() == false){
        ...
        ui->chB_maxSucess->setEnabled(true);
        ui->chB_readSucces->setEnabled(true);
        ui->chB_procFileSucces->setEnabled(true);
        ui->chB_minSucess->setEnabled(true);
...
void MainWindow::on_pb_start_clicked()
{
    ...
    auto findMax = [&](QVector<double> res){
                                                ...
                                                while(equal!=true){
                                                    ...
                                                    series->append(time_sig,res[i]);
                                                    ++i;
                                                    time_sig+=1/FD;
                                                    equal=abs(times-time_sig)<eps;
                                                }
                                                emit sig_ReadyDisplay();
